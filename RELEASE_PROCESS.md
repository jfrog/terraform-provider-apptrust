# Release Process for Terraform Provider AppTrust

## Overview

The `releaseAppTrustProvider.sh` script automates the process of creating a new release for the terraform-provider-apptrust.
...
```bash
NEW_VERSION=1.0.1 ./releaseAppTrustProvider.sh -y
```
...
Latest version for terraform-provider-apptrust: v1.0.0
-------------------------------------

Using provider: terraform-provider-apptrust
Please enter the new version number (e.g., 1.2.3): 1.0.1

--- Starting release process for provider 'terraform-provider-apptrust' and version v1.0.1 ---
...
--- Release process completed successfully for terraform-provider-apptrust! ---
```
...
2. Verify the release appears on the [Releases page](https://github.com/jfrog/terraform-provider-apptrust/releases)
3. Verify the provider is available on:
   - [Terraform Registry](https://registry.terraform.io/providers/jfrog/apptrust)
   - [OpenTofu Registry](https://registry.opentofu.org/providers/jfrog/apptrust)
