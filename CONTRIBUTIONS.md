...
Clone repository to: `$GOPATH/src/github.com/jfrog/terraform-provider-apptrust`

```sh
$ mkdir -p $GOPATH/src/github.com/jfrog
$ cd $GOPATH/src/github.com/jfrog
$ git clone git@github.com:jfrog/terraform-provider-apptrust
```

Enter the provider directory and build the provider

```sh
$ cd $GOPATH/src/github.com/jfrog/terraform-provider-apptrust
$ make build
```
