...
First, you need a running instance of the JFrog Platform with AppTrust (Artifactory 7.125.0+, Xray 3.130.5+, Enterprise Plus with AppTrust).
...
The acceptance tests use fixed project keys (`aa`, `bb`, `cc`, `dd`) defined in `pkg/apptrust/acctest/test.go`. Your test environment must have these projects pre-created.
